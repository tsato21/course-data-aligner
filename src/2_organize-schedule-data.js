...
function organizedClassScheduleDataType2() {
  ...
  let programDataSheetName = Browser.inputBox(
    `Input the name of the sheet where you pasted the class schedule data provided by the Program (e.g., 2_Schedule Data by Program).`,
  ...
  let displaySheetName = Browser.inputBox(
    `Input the name of the sheet where organized course offering data is displayed (e.g., 2_Organized Schedule Data).`,
    Browser.Buttons.OK_CANCEL
  );
