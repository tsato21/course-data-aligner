...
function organizedCourseOfferingDataType1() {
  let programDataSheetName = Browser.inputBox(
    `Input the name of the sheet where you pasted the course offering data provided by the Program (e.g., 1_Offering Data by Program).`,
  ...
  let displaySheetName = Browser.inputBox(
    `Input the name of the sheet where organized course offering data is displayed (e.g., 1_Organized Offering Data).`,
    Browser.Buttons.OK_CANCEL
  );
