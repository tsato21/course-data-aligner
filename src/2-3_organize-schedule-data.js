...
function organizedClassScheduleDataType3() {
  ...
  let programDataSheetName = Browser.inputBox(
    `Input the name of the sheet where you pasted the class schedule data provided by the Program (e.g., 2-3_Schedule Data by Program).`,
  ...
  let displaySheetName = Browser.inputBox(
    `Input the name of the sheet where organized course offering data is displayed (e.g., 2-3_Organized Schedule Data).`,
    Browser.Buttons.OK_CANCEL
  );
...
function displayRecords_(records, header, displaySheet) {
  ...
  displaySheet.getRange(2, 1, 1, header.length).setValues([header]);
